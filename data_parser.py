...
class MyParser:
    ...
    def __init__(self):
        #self.files = listdir()
        #path = os.getcwd()
        path="/Users/umangthakur/Desktop/IR/Hwk7/Hwk7_Z/trec07p/data"
        #path="./trec07p"
...
#        print(count(self.files))
    ...
    def read_html(self):
        ...
        for p in self.files:
            print(p)
            with open("/Users/umangthakur/Desktop/IR/Hwk7/Hwk7_Z/trec07p/data/{}".format(p), "r", encoding="ISO-8859-1") as f:
    ...
    def read_label(self):
        with open("/Users/umangthakur/Desktop/IR/Hwk7/Hwk7_Z/trec07p/full/index", "r") as f:
