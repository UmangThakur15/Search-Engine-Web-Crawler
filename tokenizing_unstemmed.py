...
#step 2
f = open("doc_data_unstemmed.json","r")
data = json.load(f)
...
# save_file = open("tokens.json", "w")
# json.dump({"tokens" : tokens}, save_file, indent = 6)
# save_file.close()
#
# save_file = open("words_id_dict.json", "w")
# json.dump(words_id_dict, save_file, indent = 6)
# save_file.close()
#
# save_file = open("doc_len_stat.json", "w")
...
save_file = open("tokens_unstemmed.json", "w")
json.dump({"tokens" : tokens}, save_file, indent = 6)
save_file.close()


save_file = open("words_id_dict_unstemmed.json", "w")
json.dump(words_id_dict, save_file, indent = 6)
save_file.close()


save_file = open("doc_len_stat_unstemmed.json", "w")
json.dump({"stat" : {"avg_doc_length" : sum(doc_len.values())/len(doc_len.values()),
                     "tot_num_words" : len(words_id_dict)},
           "doc" : doc_len}, save_file, indent = 6)
# print(words_id_dict)
