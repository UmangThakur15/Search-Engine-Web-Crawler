...
class PageRanking():
    ...
    def print_top_500(self):
        if os.path.exists("crawled_links/page_rank_crawl.txt"):
            os.remove("crawled_links/page_rank_crawl.txt")
        ...
        with open('crawled_links/page_rank_crawl.txt', "a") as f:
    ...
    def read_inlinks(self):
        print("inlink")
        with open("crawled_links/crawled_inlinks.txt", "r") as f:
    ...
    def read_outlinks(self):
        print("outlink")
        with open("crawled_links/crawled_outlinks.txt", "r", encoding="utf-8") as f:
            for line in f.readlines():
                print(line)
                new_line = line.replace(" \n", "")
                new_line = new_line.replace("\n", "")
